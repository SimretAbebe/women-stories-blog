    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="bg-white/70 backdrop-blur-md rounded-3xl p-12 shadow-xl border border-white/50">
        <h1 className="text-4xl font-extrabold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-pink-600 to-purple-600">
          {lang === 'en' ? "Empowering Women's Stories" : "የሴቶችን ታሪክ ማብቃት"}
        </h1>
        ...
        <div className="space-y-6 text-lg text-gray-700 leading-relaxed text-left">
          <p>
            {lang === 'en' 
              ...
              : "አለምን ለሚያነቃቁ፣ ለሚሞግቱ እና ለሚቀርጹ ድምፆች ወደ ተዘጋጀው መድረክ እንኳን በደህና መጡ። የእያንዳንዱ ሴት ጉዞ የጥንካሬ እና የተስፋ ድንቅ ስራ ነው ብለን እናምናለን።"}
          </p>
            ...
            <div className="bg-pink-50 rounded-2xl p-6">
              ...
              <p className="text-sm">
                {lang === 'en' 
                  ...
                  : "ሴቶች ልምዶቻቸውን የሚያካፍሉበት እና ከአለም አቀፍ ማህበረሰብ ጋር የሚገናኙበት ደህንነቱ የተጠበቀ እና የሚያምር ቦታ ማዘጋጀት።"}
              </p>
            </div>
            <div className="bg-purple-50 rounded-2xl p-6">
              <h3 className="font-bold text-purple-600 mb-2">
                {lang === 'en' ? "The Impact" : "ተፅዕኖው"}
              </h3>
              <p className="text-sm">
                {lang === 'en' 
                  ? "By documenting these stories, we create a living archive of wisdom and courage for future generations."
                  : "እነዚህን ታሪኮች በመመዝገብ፣ ለወደፊት ትውልዶች የጥበብ እና የድፍረት ህያው መዝገብ እንፈጥራለን።"}
              </p>
            </div>
          </div>
        </div>
